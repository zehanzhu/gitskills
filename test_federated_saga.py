...
def main():
    ...
    if os.path.exists('./ACC_federated_saga') is False:
        os.mkdir('./ACC_federated_saga')
...
def main_worker(gpu, args):
    ...
    model.cuda(gpu)
    put_path = './ACC_federated_saga'
    get_path = './Weights_federated_saga'
    ...
    np.save(put_path+'/ACC_federated_saga_{}.npy'.format(gpu), np.array(acc))
